  ...
  <div class="modal-overlay">
    <div class="modal">
        ...
        {/if}
          ...
          <label>
            Timezone:
            <select required bind:value={time_zone}>
          ...
          <label>
            Contact Choice:
            <select required bind:value={contact_choice}>
          ...
          <label>
            Report Frequency(Get a report  after the specified days): <input type="number" bind:value={report_frequency} on:input={handleInput} min={1} max={365} required />
          </label>
